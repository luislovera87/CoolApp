                        ...
                        if(i == 0){
                            ...
                            for(var j = 0; j < data[i].length; j++){
                                if(data[i][j] != ""){
                                    ...
                                    $("#header_"+i).append("<th>"+data[i][j]+"</th>")
                                }
                            }
                        }else{
                            ...
                            for(var j = 0; j < data[i].length; j++){
                                if(data[i][j] != ""){
                                    ...
                                    if(j==0){
                                        ...
                                        $("#row_"+i).append("<td><input class='Monto' value="+val+"></td>")
                                    }else if(j==3){
...
var equipoVal = "";
    ...
    //if(i==1){
        $('#table_1 tbody tr').each( function(){
            ...
            montoVal = $('td:nth-child(3) input', $(this)).val().split('$')[1].replace(',','');
...
// Chart Ventas
if(vendedorVal == 'A'){
montoA.push( {x: new Date(mesVal), y:Number(montoVal), indexLabel:'$'+montoVal});
...
if(vendedorVal == 'B'){
montoB.push( {x: new Date(mesVal), y:Number(montoVal), indexLabel:'$'+montoVal});
...
if(vendedorVal == 'C'){
montoC.push( {x: new Date(mesVal), y:Number(montoVal), indexLabel:'$'+montoVal});
...
if(vendedorVal == 'D'){
montoD.push( {x: new Date(mesVal), y:Number(montoVal), indexLabel:'$'+montoVal});
...
if(vendedorVal == 'E'){
montoE.push( {x: new Date(mesVal), y:Number(montoVal), indexLabel:'$'+montoVal});
